...
<header class="header clearfix">
		...
		<div class="main_logo" id="logo">
			<a href="index.html"><img src="{{ asset('instructor/assets/images/logo.svg')}}" alt=""></a>
			<a href="index.html"><img class="logo-inverse" src="{{ asset('instructor/assets/images/ct_logo.svg')}}" alt=""></a>
		</div>
		...
		<div class="header_right">
			<ul>
				...
				<li>
					<a href="#" class="option_links" title="cart"><i class='uil uil-shopping-cart-alt'></i><span class="noti_count">2</span></a>
				</li>
					...
					<div class="menu dropdown_ms">
						<a href="#" class="channel_my item">
							<div class="profile_link">
								<img src="{{ asset('instructor/assets/images/left-imgs/img-6.jpg')}}" alt="">
						...
						<a href="#" class="channel_my item">
							<div class="profile_link">
								<img src="{{ asset('instructor/assets/images/left-imgs/img-5.jpg')}}" alt="">
								<div class="pd_content">
									<h6>Joy Dua</h6>
						...
						<a href="#" class="channel_my item">
							<div class="profile_link">
								<img src="{{ asset('instructor/assets/images/left-imgs/img-8.jpg')}}" alt="">
								<div class="pd_content">
									<h6>Jass</h6>
				...
				<li class="ui dropdown">
					...
					<div class="menu dropdown_mn">
						<a href="#" class="channel_my item">
							<div class="profile_link">
								<img src="{{ asset('instructor/assets/images/left-imgs/img-1.jpg')}}" alt="">
								<div class="pd_content">
									<h6>Rock William</h6>
						...
						<a href="#" class="channel_my item">
							<div class="profile_link">
								<img src="{{ asset('instructor/assets/images/left-imgs/img-2.jpg')}}" alt="">
								<div class="pd_content">
									<h6>Jassica Smith</h6>
						...
						<a href="#" class="channel_my item">
							<div class="profile_link">
								<img src="{{ asset('instructor/assets/images/left-imgs/img-9.jpg')}}" alt="">
								<div class="pd_content">
				...
				<li class="ui dropdown">
					...
					<div class="menu dropdown_account">
						...
						<a href="{{ route('instructor.dashboard') }}" class="item channel_item">Dashboard</a>						
						<a href="membership.html" class="item channel_item">Paid Memberships</a>
						<a href="{{ route('instructor.profile') }}" class="item channel_item">Setting</a>
						<a href="{{ route('instructor.logout') }}" class="item channel_item">Sign Out</a>
					</div>
				</li>
			</ul>
		</div>
