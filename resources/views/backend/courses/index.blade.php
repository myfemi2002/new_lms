                                ...
                                <tr>
                                    ...
                                    <td>
                                        <h2 class="table-avatar">
                                            <a href="#" class="avatar avatar-md me-2"><img class="avatar-img rounded-circle" src="{{ (!empty($item->course_image)) ? url('upload/course_images/'.$item->course_image):url('upload/no_image.jpg') }}" alt="User Image"></a>
                                            <a href="#">{{ $item->course_name }}<span><span class="__cf_email__" data-cfemail="bed4d1d6d0fedbc6dfd3ced2db90ddd1d3">{{ $item['user']['name'] }}</span></span></a>
                                        </h2>
                                    </td>
                                    ...
                                    <td class="d-flex align-items-center">
                                        <div class="dropdown dropdown-action">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end">
                                                <ul>
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('load.course.details',$item->id) }}"><i class="far fa-eye me-2"></i>View</a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('activate.course',$item->id) }}"><i class="far fa-bell me-2"></i>Active</a>
                                                    </li>
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('deactivate.course',$item->id) }}"><i class="far fa-bell-slash me-2"></i>Deactivate</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
