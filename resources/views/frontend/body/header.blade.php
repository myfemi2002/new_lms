                                    ...
                                    <li>
                                        ...
                                        <ul class="cart-dropdown-menu">
                                            ...
                                            <li class="media media-card">
                                                ...
                                                <p class="text-black font-weight-semi-bold lh-18 mt-4" id="totalText">Total: $<span class="cart-total" id="cartSubTotal">100</span></p>
                                            </div>
                                            </li>
                                            <li>
                                                <a href="{{ route('show.cart') }}" class="btn theme-btn w-100">Got to cart <i class="la la-arrow-right icon ml-1"></i></a>
                                            </li>
...
<!-- <script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        if (cartQty.textContent.trim() === "0") {
            cartSubTotal.textContent = "Your cart is empty";
        }
    });
</script> -->
