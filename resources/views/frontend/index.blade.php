...
<!--======================================
 ...
 <section class="feature-area pb-90px">
        ...
        <div class="category-wrapper mt-30px">
            <div class="row">
                ...
                <div class="category-item">
                    <img class="cat__img lazy" src="{{ asset('upload/category_images/' . ($category->image ? $category->image : 'no_image.jpg')) }}" data-src="{{ asset('upload/category_images/' . ($category->image ? $category->image : 'no_image.jpg')) }}" alt="Category image">
                    <div class="category-content">
                        <div class="category-inner">
                            <h3 class="cat__title"><a href="{{ url('category/'.$category->id.'/'.$category->category_slug) }}">{{ $category->category_name }}</a></h3>
                            <p class="cat__meta">{{ count($course ) }}</p>
    ...
    ======================================-->
    @php
    $courses = App\Models\Course::where('status', 1)->orderBy('created_at', 'desc')->limit(9)->get();

        $courses_categories = App\Models\Category::orderBy('category_name','ASC')->get();
    @endphp
    ...
    <li class="nav-item">
        <a class="nav-link{{ !request('category') ? ' active' : '' }}" id="all-tab" data-toggle="tab" href="#all" role="tab" aria-controls="all" aria-selected="{{ !request('category') ? 'true' : 'false' }}">All</a>
    </li> 
    @foreach ($courses_categories as $category)             
        <li class="nav-item">
            <a class="nav-link{{ request('category') == $category->id ? ' active' : '' }}" id="business-tab" data-toggle="tab" href="#business{{ $category->id }}" role="tab" aria-controls="business" aria-selected="{{ request('category') == $category->id ? 'true' : 'false' }}">{{ $category->category_name }}</a>
        </li>
    @endforeach
</ul>
                            ...
                            <div class="col-lg-4 responsive-column-half">
                                <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_1{{ $course->id }}">
                                    ...
                                    <div class="card-image">
                                            ...
                                            <img class="card-img-top lazy" src="{{ asset('upload/course_images/' . ($course->course_image ? $course->course_image : 'no_image.jpg')) }}" data-src="{{ asset('upload/course_images/' . ($course->course_image ? $course->course_image : 'no_image.jpg')) }}" alt="Card image cap">
                                        </a>
                                        @php
    ...
    <div id="tooltip_content_1{{ $item->id }}">
        <div class="card card-item">
            <div class="card-body">
                <p class="card-text pb-2">By <a href="{{ route('instructor.details', $course->user) }}">{{ $item['user']['name'] }}</a></p>
                ...
                <button type="submit" class="btn theme-btn flex-grow-1 mr-3" onclick="addToCart('{{ $item->id }}', '{{ $item->course_name }}', '{{ $item->user_id }}', '{{ $item->course_name_slug }}' )" ><i class="la la-shopping-cart mr-1 fs-18"></i>Add to Cart</button>
                ...
                <div class="course-carousel owl-action-styled owl--action-styled mt-30px">
                    <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_3">
                        ...
                        <div class="card-body">
                            ...
                            <h5 class="card-title"><a href="{{ url('course-details/'.$course->id.'/'.$course->course_name_slug) }}">The Complete WordPress Website Business Course</a></h5>
                    ...
                    <div class="card card-item hover-s text-center">
                        <div class="card-body">
                            ...
                            <div class="btn-box mt-20px">
                                <a href="{{ route('become.instructor')}}" class="btn theme-btn theme-btn-sm theme-btn-white lh-30" target="_blank"><i class="la la-user mr-1"></i>Start Teaching</a>
                            </div><!-- end btn-box -->
                        </div><!-- end card-body -->
                    </div><!-- end card -->
                </div><!-- end col-lg-4 -->
