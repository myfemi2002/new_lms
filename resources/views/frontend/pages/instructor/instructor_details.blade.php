        ...
        <div class="breadcrumb-content">
            <div class="media media-card align-items-center pb-4">
                <div class="media-img media--img media-img-md rounded-full">
                    <img class="rounded-full" src="{{ ($instructor->photo) ? url('upload/instructor_images/'.$instructor->photo) : asset('instructor/assets/images/hd_dp.jpg') }}" alt="Student thumbnail image">
                </div>
                <div class="media-body">
                    ...
                    @if($instructor->headline)
                        <p class="lh-18">{{ $instructor->headline }}</p>
                    @else
                        <p class="lh-18">Talented instructor.</p>
                    @endif
            ...
            <div class="tab-content pt-40px" id="myTabContent">
                <div class="tab-pane fade show active" id="about-me" role="tabpanel" aria-labelledby="about-me-tab">
                    <div class="card card-item">
                        <div class="card-body">
                            @if(!empty($instructor->bio)) <!-- Check if bio is not empty -->
                            <p class="card-text pb-3">{{ $instructor->bio }}</p>
                            @if(strlen($instructor->bio) > 200) <!-- Checking if bio length is greater than 200 characters -->
                            ...
                            @endif
                            @else
                            <p class="card-text pb-3 text-danger">Not available</p>
                            @endif
                        </div>
                    </div>
                </div><!-- end tab-pane -->
                ...
                <div class="tab-pane fade" id="experience" role="tabpanel" aria-labelledby="experience-tab">
                    <div class="card card-item">
                        <div class="card-body">
                            @if(!empty($instructor->professional_profile)) <!-- Check if professional profile is not empty -->
                            <p>
                            {{$instructor->professional_profile}}
                            </p>
                            @else
                            <p class="text-danger">No Professional Experience available</p>
                            @endif
                        </div>
                    </div>
                </div><!-- end tab-pane -->
        ...
        <ul class="pagination justify-content-center">
            @if ($courses->onFirstPage())
                <li class="page-item disabled">
                    <span class="page-link" aria-hidden="true"><i class="la la-arrow-left"></i></span>
                </li>
            @else
                <li class="page-item">
            ...
            @else
                <li class="page-item disabled">
                    <span class="page-link" aria-hidden="true"><i class="la la-arrow-right"></i></span>
                </li>
            @endif
        </ul>
    </nav>
...
<script>
    ...
    $('.collapse-btn').on('click', function() {
        $(this).find('.collapse-btn-hide, .collapse-btn-show').toggle();
    });
</script>
@endsection