            ...
            <div class="col-lg-8 pb-5">
                <div class="course-details-content-wrap pt-90px">
                    ...
                    <div class="course-overview-card border border-gray p-4 rounded">
                        ...
                        <div class="pb-3">
                            <img width="85" class="mr-3" src="{{ asset('frontend/assets/images/sponsor-img.png') }}" alt="company logo">
                            <img width="80" class="mr-3" src="{{ asset('frontend/assets/images/sponsor-img2.png') }}" alt="company logo">
                            <img width="80" class="mr-3" src="{{ asset('frontend/assets/images/sponsor-img3.png') }}" alt="company logo">
                            <img width="70" class="mr-3" src="{{ asset('frontend/assets/images/sponsor-img4.png') }}" alt="company logo">
                        </div>
                    ...
                    <div class="course-overview-card">
                        ...
                        <div class="collapse" id="collapseMore">
                            ...
                            <ul class="generic-list-item generic-list-item-bullet fs-15">
                                @foreach(explode(',', $course->prerequisites) as $prerequisite)
                                <p class="fs-15 pb-2"> {{ trim($prerequisite) }} </p>
                                @endforeach
                            </ul>
                        </div>
                    ...
                    <div class="course-overview-card">
                        @php
                        $lectures = App\Models\CourseLecture::where('course_id', $course->id)->get();
                        $totalLectures = count($lectures);
                        $totalHours = ($totalLectures > 0) ? $course->duration : '0:00';
                        @endphp
                        ...
                        <div class="curriculum-content">
                            ...
                            <div id="accordion" class="generic-accordion">
                                ...
                                @php
                                $sectionLectures = App\Models\CourseLecture::where('course_section_id', $section->id)->get();
                                @endphp
                                <div class="card">
                                    <div class="card-header" id="heading{{ $section->id }}">
                                        ...
                                        <span class="fs-15 text-gray font-weight-medium">{{ count($sectionLectures) }} lectures</span>
                                        </button>
                                    </div>
                                    <div id="collapse{{ $section->id }}" class="collapse show" aria-labelledby="heading{{ $section->id }}" data-parent="#accordion">
                                        <div class="card-body">
                                            <ul class="generic-list-item">
                                                ...
                                                @php
                                                $durationParts = explode(':', $lecture->duration);
                                                if (count($durationParts) == 3) {
                                                $lectureDuration = intval($durationParts[0]) * 3600 + intval($durationParts[1]) * 60 + intval($durationParts[2]);
                                ...
                                @endphp
                                <div class="curriculum-header d-flex align-items-center justify-content-between pb-4">
                                    <h3 class="fs-24 font-weight-semi-bold"></h3>
                                    <div class="curriculum-duration fs-15">
                                        <span class="curriculum-total__text mr-2">
                                        <strong class="text-black font-weight-semi-bold">Total:</strong> {{ $totalLectures }} lectures
                                        </span>
                                        <span class="curriculum-total__hours">
                                        <strong class="text-black font-weight-semi-bold">Total hours:</strong> {{ sprintf('%02d:%02d:%02d', $totalHours, $totalMinutes, $totalSeconds) }}
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="instructor-wrap">
                            <div class="media media-card">
                                <div class="instructor-img">
                                    ...
                                    <img class="lazy" src="{{ ($course->user->photo) ? url('upload/instructor_images/'.$course->user->photo) : asset('instructor/assets/images/hd_dp.jpg') }}" data-src="images/small-avatar-1.jpg" alt="Avatar image">
                                    </a>
                                ...
                                <div class="media-body">
                                    ...
                                    <p class="text-black lh-18 pb-3">{{ $course['user']['headline'] }}</p>
                                    <p class="pb-3">{{ $course['user']['bio'] }}</p>
                                    <div class="collapse" id="collapseMoreTwo">
                                        <p class="pb-3">{{ $course['user']['professional_profile'] }}</p>
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="preview-course-video">
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#previewModal">
                                    <img src="{{ asset('upload/course_images/' . ($course->course_image ? $course->course_image : 'no_image.jpg')) }}" data-src="{{ asset('upload/course_images/' . ($course->course_image ? $course->course_image : 'no_image.jpg')) }}" alt="course-img" class="w-100 rounded lazy">
                            ...
                            // Assuming you have a discount_expiry_date field in your course model
                            $expiryDate = $course->discount_expiry_date;
                            // Calculate remaining days
                            $remainingDays = $expiryDate ? now()->diffInDays($expiryDate, false) : null;
                            // Check if the offer has expired
                            $hasExpired = $expiryDate && now()->gt($expiryDate);
                            // Format prices with commas and decimals
                            $sellingPriceFormatted = number_format($course->selling_price, 2);
                            $discountPriceFormatted = $course->discount_price ? number_format($course->discount_price, 2) : null;
                            @endphp
                            <div class="preview-course-feature-content pt-40px">
                                <p class="d-flex align-items-center pb-2">
                                    @if ($hasExpired)
                                    <span class="fs-35 font-weight-semi-bold text-black">${{ $sellingPriceFormatted }}</span>
                                    @else
                                    @if ($course->discount_price == NULL)
                                    <span class="fs-35 font-weight-semi-bold text-black">${{ $sellingPriceFormatted }}</span>
                                    @else
                                    <span class="fs-35 font-weight-semi-bold text-black">${{ $discountPriceFormatted }}</span>
                                    <span class="before-price mx-1">${{ $sellingPriceFormatted }}</span>
                                    <span class="price-discount">{{ round($discount) }}% off</span>
                                    @endif
                                    @endif
                                </p>
                                @if ($remainingDays !== null && $remainingDays >= 0)
                                @if ($remainingDays === 0 || $hasExpired)
                                <p class="preview-price-discount-text pb-35px">
                                    Look forward to another special discount!
                                </p>
                                @else
                                <p class="preview-price-discount-text pb-35px">
                                    {{ $remainingDays }} days left at this price!
                                </p>
                                @endif
                                @elseif ($hasExpired)
                                <p class="preview-price-discount-text pb-35px">
                            ...
                            <div class="preview-course-incentives">
                                ...
                                <ul class="generic-list-item pb-3">
                                    <li><i class="la la-play-circle-o mr-2 text-color"></i>{{ sprintf('%02d:%02d:%02d', $totalHours, $totalMinutes, $totalSeconds) }} hours on-demand video</li>
                ...
                <div class="card card-item">
                    <div class="card-body">
                        ...
                        <ul class="generic-list-item generic-list-item-flash">
                            <li class="d-flex align-items-center justify-content-between"><span><i class="la la-clock mr-2 text-color"></i>Duration</span> {{ sprintf('%02d:%02d:%02d', $totalHours, $totalMinutes, $totalSeconds) }}</li>
                            <li class="d-flex align-items-center justify-content-between">
                                <span><i class="la la-play-circle-o mr-2 text-color"></i>Lectures</span> {{ $totalLectures }}
                            </li>
                            @if ($course->resources === null || $course->resources === 0)
                            <li class="d-flex align-items-center justify-content-between">
                                <span><i class="la la-file-text-o mr-2 text-color"></i>Resources</span>
                                {{ $course->resources }}
                            </li>
                            @endif
                            ...
                            <li class="d-flex align-items-center justify-content-between"><span><i class="la la-lightbulb mr-2 text-color"></i>Skill level</span> {{ ucwords($course->level) }}</li>
                            ...
                            <li class="d-flex align-items-center justify-content-between"><span><i class="la la-certificate mr-2 text-color"></i>Certificate</span>{{ ucwords($course->certificate) }}</li>
                        </ul>
                    </div>
                </div>
                <!-- end card -->
                ...
                <div class="card card-item">
                    <div class="card-body">
                        ...
                        <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                            ...
                            <img class="mr-3 lazy" src="{{ asset('upload/course_images/' . ($related->course_image ? $related->course_image : 'no_image.jpg')) }}" data-src="{{ asset('upload/course_images/' . ($related->course_image ? $related->course_image : 'no_image.jpg')) }}" alt="Related course image">
                            </a>
                            <div class="media-body">
            ...
            <div class="view-more-carousel-2 owl-action-styled">
                ...
                <div class="card card-item">
                    <div class="card-image">
                        ...
                        <img class="card-img-top" src="{{ asset('upload/course_images/' . ($inscourse->course_image ? $inscourse->course_image : 'no_image.jpg')) }}" alt="Card image cap">
                        </a>
                        <div class="course-badge-labels">
            ...
            <div class="modal-body">
                <div class="copy-to-clipboard">
                    ...
                    <div class="input-group">
                        <!-- Adjust the URL based on the environment -->
        ...
        <div class="modal-content">
            <div class="modal-header border-bottom-gray">
                <div class="pr-2">
                    ...
                    <h5 class="modal-title fs-19 font-weight-semi-bold lh-24" id="previewModalTitle"></h5>
                </div>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true" class="la la-times"></span>
                </button>
            ...
            <!-- end modal-header -->
            <div class="modal-body">
                <video controls crossorigin playsinline poster="{{ asset('upload/course_images/' . ($inscourse->course_image ? $inscourse->course_image : 'no_image.jpg')) }}" id="player">
                    <!-- Video files -->
