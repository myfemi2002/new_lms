...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('frontend/assets/css/jquery-te-1.4.0.css') }}">
    ...
    <body>
                        ...
                        <div class="lecture-viewer-container">
                            ...
                            <div class="lecture-viewer-text-wrap">
                                <div class="lecture-viewer-text-content custom-scrollbar-styled">
                                    ...
                                    <!-- Add dynamic lecture content here -->
                                </div>
                            </div>
                        </div>
                        <!-- Lecture viewer container Ends -->
                                    ...
                                    <div class="tab-pane fade" id="course-content" role="tabpanel" aria-labelledby="course-content-tab">
                                        <div class="mobile-course-menu pt-4">
                                            <div class="accordion generic-accordion generic--accordion" id="mobileCourseAccordionCourseExample">
                                                ...
                                                @php
                                                $lectures = App\Models\CourseLecture::where('course_section_id',$sec->id)->get();
                                                @endphp
                                                <div class="card">
                                                    <div class="card-header" id="mobileCourseHeadingOne{{ $sec->id }}">
                                                        ...
                                                        <span class="fs-15"> Section {{ $key + 1 }}: {{ $sec->section_title }}</span>
                                                    ...
                                                    <div id="mobileCourseCollapseOne{{ $sec->id }}" class="collapse show" aria-labelledby="mobileCourseHeadingOne{{ $sec->id }}" data-parent="#mobileCourseAccordionCourseExample">
                                                                ...
                                                                <li class="course-item-link active">
                                                                    <div class="course-item-content-wrap">
                                                                        ...
                                                                        <div class="course-item-content">
                                                                            <h4 class="fs-15 lecture-title" onclick="playVideo('{{ asset($lect->video) }}')">{{ $lect->lecture_title }}</h4>
                                                                            <div class="courser-item-meta-wrap">
                                                                                <p class="course-item-meta"><i class="la la-play-circle"></i>{{ $lect->duration }}</p>
                                                                            </div>
                                                                        </div>
                                    ...
                                    <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview-tab">
                                        <div class="lecture-overview-wrap">
                                            <div class="lecture-overview-item">
                                                ...
                                                <p>Welcome to  <strong>{{ $course->course->course_title }}!.</strong> This course is designed to provide a comprehensive understanding of course . Whether you're a beginner or an expert in, this course will explain the benefits of taking the course.</p>
                                            </div>
                                                ...
                                                <div class="lecture-overview-stats-wrap d-flex">
                                                    ...
                                                    <div class="lecture-overview-stats-item">
                                                        <ul class="generic-list-item">
                                                            <li><span>Skill level:</span>{{ ucfirst($course->course->level) }}</li>
                                                    ...
                                                    <div class="lecture-overview-stats-item">
                                                        <ul class="generic-list-item">
                                                            ...
                                                            <li><span>Certificate:</span>{{ ucfirst($course->course->certificate) }}</li>
                                                        </ul>
                                                    </div>
                                                    <!-- end lecture-overview-stats-item -->
                                                </div>
                                            ...
                                            <div class="lecture-overview-item">
                                                <div class="lecture-overview-stats-wrap d-flex">
                                                    ...
                                                    <!-- end lecture-overview-stats-item -->
                                                    <div class="lecture-overview-stats-item lecture-overview-stats-wide-item">
                                                        <p class="pb-3">No certificate available for this course</p>
                                                    </div>
                                                    <!-- end lecture-overview-stats-item -->
                                                </div>
                                                <!-- end lecture-overview-stats-wrap -->
                                            ...
                                            <div class="lecture-overview-item">
                                                <div class="lecture-overview-stats-wrap d-flex">
                                                    ...
                                                    <div class="lecture-overview-stats-item lecture-overview-stats-wide-item lecture-description">
                                                        <h3 class="fs-16 font-weight-semi-bold pb-2">From the Author of {{ $course->course->course_name }}</h3>
                                                        ...
                                                        <div class="collapse" id="collapseMore">
                                                            ...
                                                            <ul class="generic-list-item generic-list-item-bullet">
                                                                @foreach(explode(',', $course->course->prerequisites) as $prerequisite)
                                                                <li> {{ trim($prerequisite) }} </li>
                                                                @endforeach
                                                            </ul>
                                                            <h3 class="fs-16 font-weight-semi-bold pb-2">Who this course is for:</h3>
                                                            <ul class="generic-list-item generic-list-item-bullet">
                                                            <li>{{ ucfirst($course->course->level) }}</li>
                                                        </div>
                                                ...
                                                <div class="lecture-overview-stats-wrap d-flex ">
                                                    ...
                                                    <div class="lecture-overview-stats-item lecture-overview-stats-wide-item">
                                                        <div class="media media-card align-items-center">
                                                            ...
                                                            <img src="{{ ($course->photo) ? url('upload/user_images/'.$course->photo) : asset('frontend/assets/images/small-avatar-1.jpg') }}" alt="Instructor avatar" class="rounded-full">
                                                            </a>
                                                            <div class="media-body">
                                                                <h5><a href="teacher-detail.html">{{ $course['user']['name'] }}</a></h5>
                                                                <span class="d-block lh-18 pt-2">{{ $course['user']['headline'] }}</span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="lecture-owner-decription pt-4">
                                                            <p>{{ $course['user']['bio'] }}</p>
                                                            <p>{{ $course['user']['professional_profile'] }}</p>
                                                            <p>Cheers</p>
                                                            <p>{{ $course['user']['name'] }}</p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="question-list-item">
                                                        <div class="media media-card border-bottom border-bottom-gray py-4">
                                                            <div class="media-img rounded-full flex-shrink-0 avatar-sm">
                                                                <img class="rounded-full" src="{{ asset('frontend/assets/images/small-avatar-1.jpg') }}" alt="User image">
                                                            </div>
                                                            <div class="media-body">
                                        ...
                                        <div class="lecture-overview-wrap lecture-announcement-wrap">
                                            <div class="lecture-overview-item">
                                                <div class="media media-card align-items-center">
                                                    ...
                                                    <div class="media-body">
                                                        <h5 class="pb-1"><a href="teacher-detail.html">{{ $course['user']['name'] }}</a></h5>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="client-logo-wrap text-right">
                                            <a href="#" class="client-logo-item client--logo-item-2 pr-3"><img src="{{ asset('frontend/assets/images/sponsor-img.png')}}" alt="brand image"></a>
                                            <a href="#" class="client-logo-item client--logo-item-2 pr-3"><img src="{{ asset('frontend/assets/images/sponsor-img2.png')}}" alt="brand image"></a>
                                            <a href="#" class="client-logo-item client--logo-item-2 pr-3"><img src="{{ asset('frontend/assets/images/sponsor-img3.png')}}" alt="brand image"></a>
                                        </div>
                        ...
                        <div class="course-dashboard-sidebar-wrap custom-scrollbar-styled">
                            ...
                            <div class="course-dashboard-side-content">
                                <div class="accordion generic-accordion generic--accordion" id="accordionCourseExample">
                                    ...
                                    @php
                                    $lectures = App\Models\CourseLecture::where('course_section_id',$section->id)->get();
                                    @endphp
                                    <div class="card">
                                        <div class="card-header" id="headingOne{{ $section->id }}">
                                            ...
                                            <i class="la la-angle-down"></i>
                                            <i class="la la-angle-up"></i>
                                            <span class="fs-15"> Section {{ $key + 1 }}: {{ $section->section_title }}</span>
                                            <span class="course-duration">
                                            <span>({{ count($lectures) }})</span>
                                        ...
                                        <!-- end card-header -->
                                        <div id="collapseOne{{ $section->id }}" class="collapse show" aria-labelledby="headingOne{{ $section->id }}" data-parent="#accordionCourseExample">
                                            <div class="card-body p-0">
                                                <ul class="curriculum-sidebar-list">
                                                    ...
                                                    <li class="course-item-link active">
                                                        <div class="course-item-content-wrap">
                                                            ...
                                                            <!-- end custom-control -->
                                                            <div class="course-item-content">
                                                                <h4 class="fs-15 lecture-title" onclick="playVideo('{{ asset($lecture->video) }}')">{{ $lecture->lecture_title }}</h4>
                                                                <div class="courser-item-meta-wrap">
                                                                    <p class="course-item-meta"><i class="la la-play-circle"></i>{{ $lecture->duration }}</p>
                                                                </div>
                                                            </div>
                                                            <!-- end course-item-content -->
                                                        </div>
        ...
        <script src="{{ asset('frontend/assets/js/jquery-te-1.4.0.min.js') }}"></script>
