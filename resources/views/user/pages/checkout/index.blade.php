                  ...
                  <form method="post" class="row" action="{{ route('payment') }}" enctype="multipart/form-data">@csrf
                     <div class="input-box col-lg-12">
                        ...
                        <div class="form-group">
                           <input class="form-control form--control" type="text" name="name" value="{{ Auth::user()->name }}" placeholder="e.g. Alex Smith">
                     ...
                     <div class="input-box col-lg-12">
                        ...
                        <div class="form-group">
                           <input class="form-control form--control" type="email" name="email" value="{{ Auth::user()->email }}" placeholder="e.g. alexsmith@gmail.com">
                     ...
                     <div class="input-box col-lg-12">
                        ...
                        <div class="form-group">
                           <input id="phone" class="form-control form--control" value="{{ Auth::user()->phone }}" type="tel" name="phone">
                     ...
                     <div class="input-box col-lg-12">
                        ...
                        <div class="form-group">
                           <input class="form-control form--control" type="text" name="address" value="{{ Auth::user()->address }}" placeholder="e.g. 12345 Little Baker St, Melbourne">
            ...
            <div class="card card-item">
               <div class="card-body">
                  ...
                  <div class="order-details-lists">
                     ...
                     <input type="hidden" name="instructor_id[]" value="{{ $item->options->user }}">
                  ...
                  <a href="{{ route('show.cart') }}" class="btn-text"><i class="la la-edit mr-1"></i>Edit</a>
               </div>
               <!-- end card-body -->
            </div>
            <!-- end card -->
